...
export const detailedActivities = [
  ...
  // 출처: 옛 홈페이지 session 페이지 + 2024년 대회 모집 공고(인스타 2024-09-21 실측).
  //   연혁(2024년 11월)에는 있는데 활동 소개에는 빠져 있었다.
  {
    title: "자체 데이터 분석 대회",
    description:
      "학회원이 각자 주제를 정해 데이터를 분석하고 카드뉴스로 제작해 발표하는 자체 대회입니다. 2024년에 열어 대상·우수상·장려상을 시상했습니다.",
  },
];
